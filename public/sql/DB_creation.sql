...
(default, 'Super-giants', 8000000000, 'The boundary between super and hypergiants is basically nonexistent. Stars in this range are on a continuum with supergiants being on the lower end of this continuum. Much of the  features of a hypergiant are present in supergiants and as such, can be just as unstable. Supergiants are less  luminous and massive than hypergiants as they have lost more of their fuel to stellar winds.', 'super, giant, star'),
